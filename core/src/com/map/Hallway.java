...
public class Hallway {
    ...
    private void move(float[] modifiers) {
        HallwaySegment hs = new HallwaySegment(axes.get(axes.size()-1), axes.get(axes.size()-1).cpy().add(modifiers[0], modifiers[1]), diameter, originWall);
