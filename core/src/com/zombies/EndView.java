...
public class EndView implements Screen {
    ...
    public void render(float delta) {
        ...
        spriteBatch.begin();
        Zombies.fonts.get("sans-reg:24:white").draw(spriteBatch, "Zombie Kills: " + String.valueOf(stats.zombieKills), 100, getHeight() / 2 + 10);
        Zombies.fonts.get("sans-reg:24:white").draw(spriteBatch, "Touch screen to play again.", 100, getHeight() / 2 - 10);
        spriteBatch.end();
        Gdx.gl.glFlush();
        handleKeys();
    }
